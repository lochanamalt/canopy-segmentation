...
orig_session = ort.InferenceSession("models/deeplab_canopy_seg.onnx")
quant_session = ort.InferenceSession("models/deeplab_canopy_seg_int8.onnx")

test_dataset = WheatBinaryDataset('masks/test', transform=transformation_fn)
test_loader = DataLoader(test_dataset, batch_size=BATCH_SIZE, num_workers=4)

# Prepare input test images
...
# Post-process (DeepLab usually outputs [Batch, Classes, H, W])
